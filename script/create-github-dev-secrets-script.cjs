...
const values = {
  ...
  DEV_COMMERCE_SMTP_HOST: env.CommerceFunction.SMTP_HOST,
  DEV_COMMERCE_SMTP_PORT: env.CommerceFunction.SMTP_PORT,
  DEV_COMMERCE_SMTP_USER: env.CommerceFunction.SMTP_USER,
  DEV_COMMERCE_SMTP_PASS: env.CommerceFunction.SMTP_PASS,
  DEV_COMMERCE_SMTP_FROM: env.CommerceFunction.SMTP_FROM,
  DEV_WHATSAPP_BEARER_TOKEN: env.CommerceFunction.WHATSAPP_BEARER_TOKEN,
  DEV_WHATSAPP_PHONE_NUMBER_ID: env.CommerceFunction.WHATSAPP_PHONE_NUMBER_ID,
  DEV_CUTTLY_API_KEY: env.CommerceFunction.CUTTLY_API_KEY,
