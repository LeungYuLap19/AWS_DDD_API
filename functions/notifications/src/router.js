...
const { handleProxyRoot } = require('./services/notifications');
...
const routes = {
  'ANY /notifications': handleProxyRoot,
  'ANY /notifications/{proxy+}': lazyRoute('./services/notifications', 'handleProxyAny'),
};
