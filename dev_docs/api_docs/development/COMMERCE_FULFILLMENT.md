...
| `common.missingParams` | 400 | No updatable fields provided in body |
...
| 400 | `common.missingParams` | No updatable fields in body |
...
| 401 | `common.unauthorized` | Missing or invalid JWT, or non-owner access |
